...
class TextBtn extends StatelessWidget {
  const TextBtn(this.label,
      {super.key, required this.onPressed, this.isCompact = false, this.style, this.showUnderline = false});
  final String label;
  final VoidCallback? onPressed;
  final bool isCompact;
...
class IconBtn extends StatelessWidget {
  const IconBtn(this.icon, {super.key, required this.onPressed, this.color, this.padding, this.ignoreDensity});
  final IconData icon;
  final VoidCallback? onPressed;
  final Color? color;
